...
// entry point
compilation_unit
    : BYTE_ORDER_MARK? extern_alias_directives? using_directives? global_attribute_section* (namespace_member_declarations | top_level_statements)? EOF
    ;
...
namespace_declaration
    : NAMESPACE qi = qualified_identifier (namespace_body ';'? | ';' extern_alias_directives? using_directives? namespace_member_declarations?)
    ;
